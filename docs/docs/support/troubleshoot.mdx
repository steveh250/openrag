...
When you start OpenRAG after doing this, you are prompted to go through the initial setup and onboarding process again, and you should be able to configure all initial settings as desired.
However, due to a known issue, the onboarding process might not overwrite your previous settings with your new choices after you reinstall OpenRAG.
